...
\section{Testing output width and
spacing}\label{testing-output-width-and-spacing}
\begin{Shaded}
\begin{Highlighting}[]
...
\NormalTok{    x =}\StringTok{ }\NormalTok{knitr}\OperatorTok{:::}\KeywordTok{split_lines}\NormalTok{(x)}
    ...
    \ControlFlowTok{if}\NormalTok{ (}\KeywordTok{any}\NormalTok{(}\KeywordTok{nchar}\NormalTok{(x) }\OperatorTok{>}\StringTok{ }\NormalTok{n)) x =}\StringTok{ }\KeywordTok{strwrap}\NormalTok{(x, }\DataTypeTok{width =}\NormalTok{ n, }\DataTypeTok{exdent =} \DecValTok{4}\NormalTok{, }\DataTypeTok{indent =} \DecValTok{4}\NormalTok{)}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{a <-}\StringTok{ '## "stx2A; shiga-like toxin II A subunit encoded by bacteriophage BP-933W; K11006 shiga toxin subunit A" this is just going to keep going and going until i get a third line so i can see what it looks like and do we have a third line yet?'}
\NormalTok{a}
\end{Highlighting}
\end{Shaded}
\begin{verbatim}
...
<<<<<<< HEAD:thesis_example/index/_book/lastName_firstName-thesis.tex
\BeginKnitrBlock{proof}[This is a proof]
\iffalse{} {Proof (This is a proof). } \fi{}There is a proof environment
in which you can create equations
...
\EndKnitrBlock{proof}
=======
\section{First numbered section}\label{first-numbered-section}

Lorem ipsum blah blah blah. Lorem ipsum blah blah blah. Lorem ipsum blah
blah blah. Lorem ipsum blah blah blah. Lorem ipsum blah blah blah. Lorem
ipsum blah blah blah. Lorem ipsum blah blah blah. Lorem ipsum blah blah
blah. Lorem ipsum blah blah blah.

\subsection{Numbered Subsection}\label{numbered-subsection}

Lorem ipsum blah blah blah Lorem ipsum blah blah blah.Lorem ipsum blah
blah blah. Lorem ipsum blah blah blah. Lorem ipsum blah blah blah.Lorem
ipsum blah blah blah. Lorem ipsum blah blah blah.

\subsubsection{Subsubsections do not have
numbers}\label{subsubsections-do-not-have-numbers}

Lorem ipsum blah blah blah Lorem ipsum blah blah blah.Lorem ipsum blah
blah blah. Lorem ipsum blah blah blah. Lorem ipsum blah blah blah.Lorem
ipsum blah blah blah. Lorem ipsum blah blah blah.

\paragraph{Paragraphs start in line with subsubsubsection
headers.}\label{paragraphs-start-in-line-with-subsubsubsection-headers.}

Lorem ipsum blah blah blah Lorem ipsum blah blah blah.Lorem ipsum blah
blah blah. Lorem ipsum blah blah blah. Lorem ipsum blah blah blah.Lorem
ipsum blah blah blah. Lorem ipsum blah blah blah.

\subparagraph{How deep can this go?}\label{how-deep-can-this-go}

Lorem ipsum blah blah blah Lorem ipsum blah blah blah.Lorem ipsum blah
blah blah. Lorem ipsum blah blah blah. Lorem ipsum blah blah blah.Lorem
ipsum blah blah blah. Lorem ipsum blah blah blah.
>>>>>>> parent of e92eb33... Working thesis doc!:thesis_example/_book/thesis.tex
...
\end{Shaded}
\begin{verbatim}
     Warning: package 'remotes' was built under R version 3.5.2
\end{verbatim}
\begin{verbatim}
...
\end{Shaded}
\begin{figure}
\includegraphics[width=6.58in]{figures/amherst} \caption{Amherst logo}\label{fig:amherstlogo}
\end{figure}
...
\begin{figure}
\includegraphics[scale=0.75]{figures/subdivision} \caption{Subdiv. graph}\label{fig:subd}
\end{figure}
...
version of the book.)
\begin{figure}
\includegraphics[angle=180, scale=1.1]{figures/subdivision} \caption{A Larger Figure, Flipped Upside Down}\label{fig:subd2}
\end{figure}
...
If we don't want the conclusion to have a chapter number next to it, we
can add the \texttt{\{-\}} attribute.
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{# if you like to load your packages all at once}
\CommentTok{# this is a good place to do it!}
\end{Highlighting}
\end{Shaded}
