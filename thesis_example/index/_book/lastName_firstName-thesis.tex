...
\includegraphics{lastName_firstName-thesis_files/figure-latex/pressure-1.pdf}
...
\end{Highlighting}
\end{Shaded}
\includegraphics{lastName_firstName-thesis_files/figure-latex/march3plot-1.pdf}
...
\begin{figure}
\centering
\includegraphics{lastName_firstName-thesis_files/figure-latex/delaysboxplot-1.pdf}
...
\KeywordTok{library}\NormalTok{(acthesis) }\CommentTok{# loads dpylr, ggplot2, knitr, bookdown, and remotes}
\end{Highlighting}
\end{Shaded}
