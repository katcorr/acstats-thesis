...
remotes::install_github("Amherst-Statistics/acstats-thesis")
```

3. Use the **New R Markdown** dialog to select **AC Statistics Thesis** (note that this will currently only **Knit** if you name the primary .Rmd file `index` as shown below):
