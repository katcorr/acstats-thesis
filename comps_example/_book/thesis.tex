...
\title{My Comprehensive Evaluation Report}
\author{Your R. Name}
...
\Preface{
This is an example of a thesis setup to use the amherst thesis document
...
\end{Shaded}
\begin{figure}
\includegraphics[width=6.58in]{figure/amherst} \caption{Amherst logo}\label{fig:reedlogo}
\end{figure}
Here is a reference to the Amherst logo: Figure \ref{fig:reedlogo}. Note
